...
const queryTable = ({ tableService, query, tableName, continuationToken = null }) =>
    new Promise((resolve, reject) => { // TODO uses async instead?
        tableService.queryEntities(
            ...
            (error, result, response) => {
                ...
                if (continuationToken !== (undefined || null)) {
                    const values = queryTable({ tableName, select, continuationToken })
                        .then(values => {
